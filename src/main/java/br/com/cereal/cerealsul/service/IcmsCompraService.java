...
public class IcmsCompraService {
    ...
    private double calculaTaxaIcmsSojaCompra(String estadoSaidaMaterial,
        ...
        if (estadoSaidaMaterial.equals("DF") && estadoFilial.equals("GO")) {
            ...
            if (proRural && (atividadeCompra.equals(TipoAtividadeCompra.COOPERATIVA)
    ...
    private double calculaTaxaIcmsMilhoCompra(String estadoSaidaMaterial,
        ...
        // DF - GO > PROD COM PRORURAL
        if (estadoSaidaMaterial.equals("DF") && estadoFilial.equals("GO")
                && atividadeCompra.equals(TipoAtividadeCompra.PROD) && proRural) {
            valorCalculo = 0.024;
        }
        // DF - GO > PROD SEM PRO RURAL, COOPERATIVA E CEREALISTAS
        if (estadoSaidaMaterial.equals("DF") && estadoFilial.equals("GO") && !proRural) {
            valorCalculo = 0.12;
        ...
        // DF - MG > PROD SEM PRORURAL, COOPERATIVA E CEREALISTA
        if (estadoSaidaMaterial.equals("DF") && estadoFilial.equals("MG") && !proRural) {
            valorCalculo = 0.12;
        }
        // MG - MG > PROD OU COOPERATIVA
        if (estadoSaidaMaterial.equals("MG") && estadoFilial.equals("MG")
